...
func (s *TelegramService) StartRun() {
	...
	for update := range updates {
		...
		case "github":
			msg.Text = `
👩🏻‍💻 Here's the link to the project: https://github.com/efakhimi/x-ui-english/
...
📍 Github   : https://github.com/efakhimi
📞 Telegram: @efakhimi (Contact for any issues. Please be patient. As I am a student, I may not be able to reply immediately.)
